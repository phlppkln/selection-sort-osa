    ...
    <div class="slides-container">
      ...
      <div class="slide" v-else-if="pageNumber === 3">
        <div class="main-text">
          ...
          die Karte und können deren Wert lesen. Probieren Sie es aus, indem Sie
          auf das Auge unter verschiedenen Karten klicken.
        </div>
        <div class="additional-text">
          Die meisten Menschen würden wahrscheinlich zuerst alle Karten
          umdrehen, um sich einen Überblick zu verschaffen. Ein Computerprogramm
          kann das jedoch nicht. Deswegen wird in dieser Aufgabe ein Lesezeiger
          eingesetzt, der die Vorgehensweise eines Computerprogrammes beim Lesen
          einer Karte simuliert.
        </div>
      </div>
      ...
      <div class="slide" v-else-if="pageNumber === 5">
        <div class="main-text">
          ...
          sichtbaren Karte sichtbar halten, auch wenn der Lesezeiger nicht mehr
          auf diese Karte gerichtet ist. Wird der Merkzeiger auf eine andere
          Karte gesetzt, steht der Wert nicht mehr zur Verfügung. Setzen Sie nun
          den Merkzeiger auf die Karte, deren Wert Sie sehen und stellen Sie
          anschließend den Lesezeiger auf eine andere Karte. Wie Sie sehen,
          können Sie durch die Kombination der Hilfsmittel Lesen und Merken die
        ...
        <div class="additional-text">
          ...
          Merkzeigers ist es jetzt möglich, zwei Kartenwerte gleichzeitig sehen
          zu können.
        </div>
      </div>
      <div class="slide" v-else-if="pageNumber === 6">
        <div class="main-text">
          ...
          sichtbarem Wert, halten Sie die Maustaste gedrückt und ziehen Sie die
          Karte auf jene, mit der Sie tauschen möchten. Den Tausch schließen Sie
          ab, indem Sie auf das grüne Häkchen klicken. Der Klick auf „x“ bricht
          den Tausch ab.
        </div>
        <div class="additional-text"></div>
      </div>
      ...
      <div class="slide" v-else-if="pageNumber === 8">
        <div class="main-text">
          ...
          bereits sortierter Zahlen vom Bereich noch zu sortierender Zahlen ab.
          Klicken Sie dazu auf das Wort „FIX“ auf dem jeweiligen Speicherplatz.
          Mit jeder sortierten Karte muss der Fixierbereich erweitert werden. Im
          fixierten Bereich sind dann auch keine Operationen mehr möglich.
          Versuchen Sie, die Aufgabe möglichst effizient, d. h. mit wenigen
          Schritten zu lösen.
        </div>
        <div class="additional-text">
          Damit das Programm nicht „vergisst“, welche Zahlen schon sortiert sind
          und wo noch zu sortieren ist, verwendet es die Fixierfunktion.
        </div>
      </div>
      <div class="slide" v-else-if="pageNumber === 9">
        <div class="main-text">
          Der Arbeitsbereich enthält die (noch) zu sortierenden Zahlen. Der
          Lesezeiger und der Merkzeiger können nur im Arbeitsbereich angewendet
          werden!
        </div>
        <div class="additional-text"></div>
      </div>
